...
(async () => {
    ...
    await page.click('#t1 > table > tr:nth-child(5) > td:nth-child(10) > button');
    await page.click('#t1 > table > tr:nth-child(4) > td:nth-child(6) > button');
    await page.click('#t1 > table > tr:nth-child(1) > td:nth-child(1) > button');
    await page.click('#t1 > table > tr:nth-child(5) > td:nth-child(13) > button');
